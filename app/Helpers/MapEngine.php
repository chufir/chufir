...
class MapEngine
{
    ...
    public static function scripts()
    {
        ...
        switch (setting_item('map_provider')) {
            case "gmap":
                $html .= sprintf("<script src='https://maps.googleapis.com/maps/api/js?key=AIzaSyAm_ZEJZ58IDAn9IjtGr3a9Y0UKKjOcWI0&libraries=places'></script>", setting_item('map_gmap_key'));
