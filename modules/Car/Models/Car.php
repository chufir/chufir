...
class Car extends Bookable
{
    ...
    public function fill(array $attributes)
    {
        if(!empty($attributes)){
            ...
            $attributes['location_id'] = $attributes['location_id'] ?? null;
            $attributes['destination_id'] = $attributes['destination_id'] ?? null;
            $attributes['car_type'] = $attributes['car_type'] ?? null; // Economy or VIP
        }
