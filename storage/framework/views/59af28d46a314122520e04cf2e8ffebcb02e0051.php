                    ...
                    <div class="col-xl-7 col-lg-8">
                        ...
                        <h2 class="text-22 fw-500"><?php echo e(__('Let us know who you are')); ?></h2>
                         ...
                         <div class="booking-form " style="display:none">
                             <?php echo $__env->make('Booking::frontend/booking/checkout-deposit-amount',['disable_lazyload'=>1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                             <?php if(!empty($token = request()->input('token'))): ?>
                                 <input type="hidden" name="token" value="<?php echo e($token); ?>">
                             <?php endif; ?>
                         </div>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        function checkPaynow(){
            ...
            $('.deposit_amount').val(pay_now_need_pay)
            console.log(pay_now_need_pay)
        }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\chufir\themes/GoTrip/Booking/Views/frontend/checkout.blade.php ENDPATH**/ ?>