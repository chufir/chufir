    ...
    <div data-x-dd-click="searchMenu-loc">
        ...
        <div class="text-15 text-light-1 ls-2 lh-16 @if( $type == "autocomplete") smart-search  @endif ">
            ...
            <input type="text" autocomplete="on"
             ...
             class="smart-search-location parent_text js-search js-dd-focus" placeholder="{{__("Enter Pickup Point")}}" value="{{ $location_name }}" data-onLoad="{{__("Loading...")}}" data-default="{{ json_encode($list_json) }}">
        </div>
    </div>
